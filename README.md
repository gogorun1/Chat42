*This project has been created as part of the 42 curriculum by jili, \<login2\>, \<login3\>, \<login4\>, \<login5\>.*
...
| wding(gogo) | AI Dev | Owns **F9** (Moulinette AI persona: diary generation, Q&A) and the cat-detection half of **F2** |
